  ...
  return (
    <div className="flex">
      ...
      <div className="flex mx-16 my-8 items-center justify-around w-2/3">
        <div ref={printRef} id="cv-container" className="flex w-[840px] h-[1188px] border" style={{"backgroundColor": (selectedColor?.value || "white")}}>
          {selectedColor?.value}
        </div>
      </div>
      {/* EDIT SECTION */}
      <div className="flex flex-col w-1/3 pr-16 mt-8">
        <div className="w-full">
          ...
          <select
            className="w-full h-fit p-2.5 bg-white border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          >
