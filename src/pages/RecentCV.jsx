...
export default function MyRecentCVPage() {
	const navigate = useNavigate()

	return (
		<div className="font-sans text-[#111] bg-white pb-5">
			{/* Filter Bar */}
			...
			<section className="mx-20 my-8 p-6 mx-35 bg-white border border-black rounded-lg">
				<h3 className="text-xl font-semibold mb-2">CV gần đây của bạn</h3>
				<p className="text-sm text-gray-600 mb-6 -mt-1">
					Bạn đang muốn tìm cơ hội việc làm mới?{' '}
					<a href="#" className="text-blue-600">
						Cập nhật CV của bạn
					</a>{' '}
					để nhận được gợi ý việc làm tốt hơn.
				</p>
				...
				<div className="flex flex-wrap gap-6 justify-between">
					{cvList.map((cv, index) => (
						<div key={index} className="bg-gray-200 w-[30%] h-[750px] rounded-lg shadow border border-gray-300 mb-15">
							...
							<div className="flex justify-between items-center mt-71 px-2">
								<div>
