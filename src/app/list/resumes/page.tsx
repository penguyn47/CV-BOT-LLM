									...
									{openMenuId === item.id && (
										...
										>
											<button
												...
												className="block w-full px-4 py-2 text-left text-sm hover:cursor-pointer hover:bg-gray-300"
											>
												Chỉnh sửa
											</button>
											...
											<button
												...
												className="block w-full px-4 py-2 text-left text-sm text-red-600 hover:cursor-pointer hover:bg-gray-300"
											>
												Xóa
											</button>
										</div>
