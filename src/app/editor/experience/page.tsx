	...
	const handleImproveHint = async (hint: Hint) => {
		...
		try {
			...
			if (response.ok) {
				...
				setExperiences(data.resumeData.workExperiences || [])
				...
				alert('Đã xảy ra lỗi khi cải thiện kinh nghiệm.')
			}
		} catch (error) {
		...
		<>
			...
			<div className="col-span-1">
				...
				<OneStepNavBar
					...
					linkNext={`/editor/skills?resumeId=${resumeId}`}
				/>
			</div>
